...
import icons from "url:../../img/icons.svg"; // Parcel 2 (for static files "Not Programming Files" like Images)
...
class RecipeView extends View {
  ...
  addHandlerUpdateService(handler) {
    this._parentEl.addEventListener("click", (e) => {
      ...
      const { updateServ } = btn.dataset;
      if (+updateServ <= 1) return;
      handler(+updateServ);
    });
  }
  ...
  _genMarkup() {
    ...
    <div class="recipe__ingredients">
      ...
      <ul class="recipe__ingredient-list">
        ${this._data.ingredients.map(this._genMarkupIng).join("")}
      </ul>
    </div>
